...
Study notes organized by AWS service domain.
...
- [`official-exam-guide.md`](official-exam-guide.md) — the official AWS exam guide's own domains/tasks/knowledge-skills and in-scope/out-of-scope service lists, captured verbatim as a reference for mapping our notes against
- [`exam-guide-mapping.md`](exam-guide-mapping.md) — cross-references the guide above against these notes: by task (what to study, weighted) and by service (is X covered, and where)
...
- [`03-storage/`](03-storage/) — EBS, EFS, S3, Glacier, FSx, Storage Gateway
...
- [`13-machine-learning/`](13-machine-learning/) — Amazon Q, Rekognition, Transcribe, Polly, Translate, Lex, Connect, Comprehend, SageMaker, Kendra, Personalize, Textract

## Sources

- [Stellex Group SAA-C03 Cheat Sheet](https://www.stellexgroup.com/blog/aws-solutions-architect-associate-saa-c03-cheat-sheet) — base content for these notes
- Gap analysis against the official SAA-C03 exam guide domains — flagged concepts the cheat sheet didn't cover; files marked "To research" need your own study to fill in
